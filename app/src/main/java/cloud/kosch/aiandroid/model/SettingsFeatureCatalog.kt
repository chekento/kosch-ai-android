...
object SettingsFeatureCatalog {
    ...
    val all: List<SettingsFeatureDefinition> = buildList {
        ...
        add(f("assistant.presence", SettingsSection.ASSISTANT, "Portal/Ambient/Floating/Full/Agent", GD, SettingMaturity.LIVE, portability = SettingPortability.DEVICE_LOCAL))
        ...
        add(f("assistant.wake_word", SettingsSection.ASSISTANT, "Wake Word: Aus/Computer/Name/Custom", GD, SettingMaturity.LIVE, portability = SettingPortability.DEVICE_LOCAL))
